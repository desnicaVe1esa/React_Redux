...
window.localStorage = {}
/*
    Jest дает возможность перед активизацией любых тестов запускать сценарий, где можно настроить дополнительные
    глобальные переменные, которые могут использоваться в любом из наших тестов
 */
