...
// Тесты проверяют способность хранилища успешно добавлять новые цвета с помощью создателей действий
...
describe("Action Creators", () => {
    ...
    describe("addColor", () => {
        ...
        // beforeAll - вызывается до выполнения каждого набора тестов
        beforeAll(() => {
            store = storeFactory({colors})
            store.dispatch(addColor("Dark Blue", "#000033"))
        })

        // afterAll - вызывается после выполнения каждого набора тестов
        afterAll(() => global.localStorage['redux-store'] = false)

        it("should add a new color", () =>
            // toBe - сравнивает результаты с помощью ===
        ...
        it("should set timestamp", () =>
            // toBeDefined - используется для проверки наличия переменной или функции
