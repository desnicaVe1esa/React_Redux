...
/*
    Имитация компонента ColorList. Среда Jest знает, что реализацию данного имитатора нужно искать в папке __mocks__.
    Настоящий ColorList больше не используеся. Применяется урезанный компонент-имитатор
*/
