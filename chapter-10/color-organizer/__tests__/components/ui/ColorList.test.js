...
/*
    jest.mock - вставка имитатора вместо настоящего теста. Первый аргумент - модуль, который нужно сымитировать,
    второй - функция, возвращающая сымитированный компонент

    Команда jest --coverage - выдача данных об охвате кода тестами
*/
