import { Link, Route } from 'react-router-dom' /*
                                                  Link - применяется для создания браузерных ссылок
                                                */
...
export const Home = () =>
    // Навигация со ссылкой для каждого маршрута
    <div className="home">
...
/*
    Компонент для неопределенных маршрутов. Когда пользователь введет маршрут, который не был обпеределен, будет получено
    свойство в виде запрашиваемого пути
*/
